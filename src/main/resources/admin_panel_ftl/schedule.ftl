    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="/admin/schedule?action=edit&id=${route.id}" class="btn btn-secondary float-right mr-2" role="button">${route.departureStart.departureFrom}</a></td>
                <td><a href="/admin/schedule?action=edit&id=${route.id}" class="btn btn-secondary float-right mr-2" role="button">${route.departureEnd.departureFrom}</a></td>
                <td>
